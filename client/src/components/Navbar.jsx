  ...
  return (
    <div>
      <div className="w-full">
        {/* Navigation starts */}
        <nav className="h-16 flex items-center lg:items-stretch justify-center lg:justify-between bg-gray-50 shadow relative z-10">
          <div className="hidden lg:flex w-full pr-6">
            ...
            <div className="w-1/3 hidden lg:flex">
              <div className="w-full flex items-center justify-center">
                <div className="h-full w-28 flex items-center justify-center border-r border-l cursor-pointer text-gray-600">
                  Admin
                </div>
                <div className="h-full w-28 flex items-center justify-center border-r cursor-pointer text-gray-600">
                  Dashboard
                </div>
                <div className="h-full w-28 flex items-center justify-center border-r mr-4 cursor-pointer text-gray-600">
                  Quotations
                </div>
                <div className="h-full w-24 flex items-center justify-center border-r pr-3 cursor-pointer text-gray-600">
                  Contracts
                </div>
              </div>
            </div>
          ...
          >
            {show ? (
              <h1 className="ml-5 mb-2">Epcorn Portal</h1>
            ) : (
